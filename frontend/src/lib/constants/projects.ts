export const projects = [
    {
        ...
        materials: [
            { name: 'Java', img: '/skills/backend/java.svg' },
            { name: 'MySQL', img: '/skills/backend/mysql.svg' },
            { name: 'Microsoft SQL Server', img: '/skills/backend/MicrosoftSQLServer.svg' },
        ],
    },
    {
        repo: 'PocketExpress',
        ...
        materials: [
            { name: 'Java', img: '/skills/backend/java.svg' },
            { name: 'SQLite', img: '/skills/backend/sqlite.svg' },
        ],
    },
    {
        repo: 'GuideBot',
        ...
        materials: [
            { name: 'Javascript', img: '/skills/frontend/javascript.svg' },
            { name: 'Node.js', img: '/skills/backend/nodejs.svg' },
            { name: 'Discord.js', img: '/skills/backend/discordjs.svg' },
            { name: 'Google Gemini', img: '/skills/ai/gemini.svg' },
