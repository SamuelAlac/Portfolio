export const projects = [
    ...
    },
    {
        ...
        startDate: '2025',
        description: 'This is my personal project, where I used React, tailwindCSS, DaisyUI and Firebase to showcase my front-end skills.',
        materials: [
            { name: 'Typescript', img: '/skills/frontend/typescript.svg' },
            { name: 'React.js', img: '/skills/frontend/react.svg' },
            { name: 'Vite', img: '/skills/frontend/vite.svg' },
            { name: 'React Router', img: '/skills/frontend/reactrouter.svg' },
            { name: 'Tanstack', img: '/skills/frontend/tanstack.svg' },
            { name: 'Redux', img: '/skills/frontend/redux.svg' },
            { name: 'TailwindCSS', img: '/skills/frontend/tailwindcss.svg' },
            { name: 'DaisyUI', img: '/skills/frontend/daisyUI.svg' },
